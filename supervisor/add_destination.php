...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        if (empty($name)) {
            ...
            $stmt = $con->prepare("INSERT INTO destination (name, description, working_hours, `range`, phone_number, supervisor_id, city_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<div class="container">
    <div class="justify-content-center d-flex   text-center  py-5  ">
        ...
        <?php
            ...
            <button type="submit" class="btn btn-primary px-4 py-2" name="addDestination">
                إضافة
            </button>
